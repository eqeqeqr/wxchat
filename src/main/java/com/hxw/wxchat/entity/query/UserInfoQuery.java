...
public class UserInfoQuery extends BaseParam {
	...
	public void setAraaCodeFuzzy(String araaCodeFuzzy){
		this.araaCodeFuzzy = araaCodeFuzzy;
	}

	public String getAraaCodeFuzzy(){
		return this.araaCodeFuzzy;
	}
